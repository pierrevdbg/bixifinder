...
class BixisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bixi" do
    assert_difference('Bixi.count') do
      post bixis_url, params: { bixi: { installDate: @bixi.installDate, installed: @bixi.installed, lastCommWithServer: @bixi.lastCommWithServer, lastUpdateTime: @bixi.lastUpdateTime, latitude: @bixi.latitude, locked: @bixi.locked, longitude: @bixi.longitude, name: @bixi.name, nbBikes: @bixi.nbBikes, nbEmptyDocks: @bixi.nbEmptyDocks, public: @bixi.public, removalDate: @bixi.removalDate, station_id: @bixi.station_id, temporary: @bixi.temporary, terminalName: @bixi.terminalName } }
    end
